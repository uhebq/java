...
/**
 * UnCheckedException
 *   - RuntimeException을 상속하고 있는 예외를 ==>> 실행예외
 ...
 *	- NullPointerException : 참조변수의 값이 null인 경우 주소접근자를 사용시
...
public class D_UnCheckedException {
	...
	public void method1() {
		...
		// 엔터가 그냥 남아 있어서 nextLine() 자동으로 실행
	...
	// NagativeArraySizeException이 발생할 소지가 있으므로
	// 입력된 값이 양수인지 체크합니다.
	if (size < 0) {
	...
	try {
		// 방번호는 0부터 시작하므로
		// 배열의 생성길이 size보다 1 작은수까지 참조가 가능하다.
